...
public class QrCodeController {
    ...
    /*
     * This method handles GET requests to the /qr/{shortUrl} endpoint. It generates
     * a QR code for the specified short URL in the requested format (PNG or SVG)
     * and size.
     * The method constructs the redirect URL using the base URL and the short URL,
     * retrieves the original URL associated with the short URL, and then calls the
     * QrCodeService to generate the QR code.
     * The generated QR code is returned in the response with the appropriate
     * content type and disposition headers. If any error occurs during QR code
     * generation, a 500 Internal Server Error response is returned.
     */
    ...
    public ResponseEntity<byte[]> getQrCode(
        ...
        try {
            ...
            // Retrieve the original URL associated with the short URL from the
            // UrlMappingService
